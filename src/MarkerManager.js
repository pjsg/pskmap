...
class MarkerManager {
    ...
    getLargeMarkerUri(colors, snr = null) {
        ...
        const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="600 150 2500 1750" height="32" width="18">
      ${pattern}
    ...
    createMarkerFeature(pos, options = {}) {
        ...
        if (!style) {
            ...
            style = new Style({
                image: new Icon({
                    src: uri,
                    anchor: [0.23, 0.985], // Balloon tip at path point (1174,1873) in viewBox 600,150 2500x1750
                    opacity: opacity,
                    scale: scale
                })
            });
